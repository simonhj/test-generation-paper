...
\begin{alltt}
 ...
 State st, BalanceType bt, Customer cust, Customer cust1; 
 Order ord, Order ord1, Invoice inv;

 CreateCustomer(st, bt, out: cust);
 AddCreditLimit(cust, int crLimit, out: cust1);
 CreateOrder(cust, out: ord);
 CreateItem(int price, out: item);
 AddItemToOrder(ord, item, out: ord1);
 GenerateInvoice(ord1, out: inv);  
\end{alltt}}%
\vspace*{-5pt}
