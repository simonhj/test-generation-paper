...
Finally, our previous work \wateg{}~\cite{Thummalapenta:2013} also accepts business rules 
and generates tests by crawling an application's GUI. The rules handled in our previous
...
using GUI elements such as links, text boxes, or buttons. In our future work, we plan
to combine \tool{} with \wateg{}, where \tool{} generates sequences (with
