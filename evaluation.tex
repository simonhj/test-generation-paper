...
\begin{figure}[t]
\centering
\includegraphics[width=0.7\columnwidth, clip, trim = 19mm 127mm 145mm
  21mm]{figs/Study-1.pdf}
\vspace*{-10pt}
...
\exhaust{} explored on average $480$ sequences for each rule part (and also hit
